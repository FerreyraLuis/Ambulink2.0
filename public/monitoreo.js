document.addEventListener('DOMContentLoaded', async () => {
  ...
  // 🔹 Función GLOBAL para el botón "Nuevo paciente"
  window.nuevoPaciente = function() {
    localStorage.removeItem('salida_activa'); // Elimina paciente activo
    limpiarClinica(); // Limpia toda la pantalla
    alert('✅ Nuevo paciente activado. Pantalla reiniciada.');
  };

  // 🔹 Escuchar evento de reset desde otro tab si fuera necesario
  ...
  // 🔹 Si hay paciente activo, cargar datos
  if(idSalida){
    try {
